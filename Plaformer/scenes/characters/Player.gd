...
func dagger_number():
	if dagger_number == 1:
		$UI/WeaponMenu/Dagger1.show()
		$UI/WeaponMenu/Dagger2.hide()
		$UI/WeaponMenu/Dagger3.hide()
		$UI/WeaponMenu/Dagger4.hide()
		$UI/WeaponMenu/Dagger5.hide()
		$UI/WeaponMenu/Dagger6.hide()
		$UI/WeaponMenu/Dagger7.hide()
		$UI/WeaponMenu/Dagger8.hide()
		$UI/WeaponMenu/Dagger9.hide()
		$UI/WeaponMenu/Dagger10.hide()
	elif dagger_number == 2:
		$UI/WeaponMenu/Dagger1.show()
		$UI/WeaponMenu/Dagger2.show()
		$UI/WeaponMenu/Dagger3.hide()
		$UI/WeaponMenu/Dagger4.hide()
		$UI/WeaponMenu/Dagger5.hide()
		$UI/WeaponMenu/Dagger6.hide()
		...
		$UI/WeaponMenu/Dagger8.show()
		$UI/WeaponMenu/Dagger9.show()
		$UI/WeaponMenu/Dagger10.show()
	elif dagger_number == 0:
		$UI/WeaponMenu/Dagger1.hide()
		$UI/WeaponMenu/Dagger2.hide()
		$UI/WeaponMenu/Dagger3.hide()
		$UI/WeaponMenu/Dagger4.hide()
		$UI/WeaponMenu/Dagger5.hide()
